...
export function resolveColor(
  cell: { isFgDefault: () => boolean; isFgRGB: () => boolean; isFgPalette: () => boolean; getFgColor: () => number; isBgDefault: () => boolean; isBgRGB: () => boolean; isBgPalette: () => boolean; getBgColor: () => number },
  type: "fg" | "bg",
): string {
  if (type === "fg") {
